...
//		vo.setUserid("아이디수정"); 같은 코드 추가 할 수도 있다는 의미~? 
	...
	@Override
	public void changeMember(MemberVO changeVO) {
		System.out.println("DAOImpl : changeMember(MemberVO changeVO) 호출");
		
		// sql 구문 호출 
		sqlsession.update(NAMESPACE + ".changeMember", changeVO);
